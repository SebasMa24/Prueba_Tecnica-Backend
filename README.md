...
Por facilidad el backend cuenta con un **schema.sql** y **data.sql**, por lo que para el correcto funcionamiento cada vez que se realiza una ejecución se debe bajar el contenedor y volverlo a subir.
